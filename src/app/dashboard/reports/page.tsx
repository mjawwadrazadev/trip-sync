...
export default function ReportsPage() {
  ...
  async function loadPnl() {
    ...
    setPnl(await res.json()); setLoadingPnl(false);
  }
  ...
  async function loadAging() {
    ...
    setAging(data.aging || []); setLoadingAging(false);
  }
                ...
                <div className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-5 rounded-xl bg-emerald-50 dark:bg-emerald-500/5 border border-emerald-100 dark:border-emerald-500/10">
                      ...
                      <p className="text-[11px] text-emerald-500 mt-1">{pnl.invoice_count} invoices</p>
                    </div>
