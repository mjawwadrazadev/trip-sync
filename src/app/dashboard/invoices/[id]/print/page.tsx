...
export default async function PrintInvoicePage({ params }: PrintParams) {
  ...
  const css = `
    * { box-sizing: border-box; margin: 0; padding: 0; }
    html, body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; background: #ffffff !important; color: #0f172a !important; color-scheme: light !important; }
    .print-wrapper { background: #ffffff !important; min-height: 100vh; color: #0f172a !important; width: 100%; }
    .no-print { position: fixed; top: 16px; right: 16px; z-index: 50; display: flex; gap: 8px; }
    .page { max-width: 860px; margin: 0 auto; padding: 36px; min-height: 100vh; background: #ffffff !important; color: #0f172a !important; }
    ...
    td { padding: 8px; border-bottom: 1px solid #f1f5f9; vertical-align: top; color: #0f172a; }
  ...
  return (
    <div className="print-wrapper bg-white text-slate-900 min-h-screen">
